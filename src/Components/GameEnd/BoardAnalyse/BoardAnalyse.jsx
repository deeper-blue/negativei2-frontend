...
import './BoardAnalyse.scss';
import { auth } from '../Firebase';
import { Link } from 'react-router-dom';

class BoardAnalyse extends React.Component {
  constructor() {
      super();
      this.state = {
          hours: ""
  ...
  //             <button onClick={() => this.generate_table()} className="button large large-font home-link">Board analyse</button>
  //         </div>
  //
  //     );
  // }
